            ...
            this.appVue = new Vue({
                ...
                methods: {
                    ...
                    isEmptySkuList: function () {
                        console.log(this.spec_list.length)
