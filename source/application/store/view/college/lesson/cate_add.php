                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="pid"
                                        ...
                                        <?php if (isset($cate_list)): foreach ($cate_list as $item): ?>
                                            <option value="<?= $item['lesson_cate_id'] ?>"><?= $item['title'] ?></option>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="is_show" value="1" data-am-ucheck
                                               checked>
                                        显示
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="is_show" value="0" data-am-ucheck>
                                        隐藏
                                    </label>
                                </div>
                            </div>
