    ...
    $(function () {
        ...
        App = new Vue({
            ...
            data : {
                ...
                questions:<?= json_encode($cate_list) ?>,
                activeName: '1',
                checkbox:[],
                radio:'',
                input:'',
            ...
            methods : {
                ...
                submit: function(){
                    let [questionnaire_id, title, status, questions, questionnaire_no] = [this.questionnaire_id, this.ruleForm.title, this.ruleForm.status, this.questions, this.ruleForm.questionnaire_no]
                    ...
                    $.post("<?= url('content.questionnaire/edit') ?>", {title, status, questionnaire_no, questions:questions_post, questionnaire_id}, function(res){
                        if(res.code == 1){
