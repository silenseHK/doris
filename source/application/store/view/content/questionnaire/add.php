    ...
    $(function () {
        ...
        App = new Vue({
            ...
            methods : {
                ...
                submit: function(){
                    let [title, status, questions, questionnaire_no] = [this.title, this.status, this.questions, this.questionnaire_no]
                    ...
                    $.post("<?= url('content.questionnaire/add') ?>", {title, status, questionnaire_no, question_ids}, function(res){
                        if(res.code == 1){
