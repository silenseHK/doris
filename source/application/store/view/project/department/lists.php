                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('project.company/edit')): ?>
                                                <a href="<?= url('project.company/edit', ['id' => $item['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('project.company/delete')): ?>
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('project.company/delete') ?>";
