                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <el-form ref="form" :model="form" label-width="120px">
                                ...
                                <el-form-item label="登录密码[不修改不填写]">
        ...
        var App = new Vue({
            ...
            methods: {
                onSubmit() {
                    ...
                    $.post("<?= url('project.staff/edit') ?>", {...this.form}, function(res){
                        if(res.code == 1){
            ...
            computed: {
                ...
                check(){
                    if(!this.form.title || !this.form.a_id || !this.form.c_id || (this.form.is_expert != 0 && this.form.is_expert != 1) || !this.form.role_id || !this.form.account || !this.form.status || !this.can_submit)
                        return false;
                    return true;
                },
            },
