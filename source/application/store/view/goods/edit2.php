                                            ...
                                            <?php foreach ($gradeList as $item): ?>
                                                <div class="am-input-group am-margin-bottom-sm">
                                                    ...
                                                    <input type="number" class="am-form-field"
                                                           ...
                                                           value="<?php if(isset($item['price'])){ echo $item['price']; } ?>" min="0.01" max="100000" required>
                                            ...
                                            <?php foreach ($gradeList as $item): ?>
                                                <div class="am-input-group am-margin-bottom-sm">
                                                    ...
                                                    <input type="number" class="am-form-field"
                                                           ...
                                                           value="<?php if(isset($item['rebate'])){echo $item['rebate']; } ?>" min="0.01" max="1000" required>
                                                    <span class="am-input-group-label am-input-group-label__right">元</span>
...
<!--                                    </label>-->
                            ...
                            <div class="am-form-group integral_weight_content <?= $model['is_add_integral'] == 0 ? 'hide' : '' ?>">
