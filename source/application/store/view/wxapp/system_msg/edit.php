                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="content"
                                           value="<?= $info['content'] ?>" placeholder="请输入简述" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="url"
                                           value="<?= $info['url'] ?>" placeholder="请输入跳转链接">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="params"
                                           value="<?= $info['params'] ?>" placeholder="请输入跳转链接">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="container" name="detail" type="text/plain"><?= $info['detail'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group switch-expire_type expire_type__20">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="j-startTime am-form-field am-margin-bottom-sm"
                                           name="effect_time" placeholder="请选择生效时间" value="<?= date('Y-m-d', $info['effect_time']) ?>" required>
                                </div>
                            </div>

                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3 am-margin-top-lg">
                                    <input type="hidden" name="message_id" value="<?= $info['id'] ?>" />
