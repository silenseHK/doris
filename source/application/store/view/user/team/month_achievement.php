                                        ...
                                        <template>
                                            <el-table
                                                ...
                                                <el-table-column
                                                        ...
                                                        label="个人业绩">
                                                    <template slot-scope="scope">
                                                        <el-link :underline="false" type="primary">{{scope.row.self_achievement}}</el-link>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column
                                                        align="center"
                                                        label="团队业绩">
                                                    <template slot-scope="scope">
                                                        <el-link :underline="false" type="primary">{{scope.row.team_achievement}}</el-link>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column
                                                        align="center"
                                                        label="总业绩">
                                                    <template slot-scope="scope">
                                                        <el-link :underline="false" type="primary">{{parseFloat(scope.row.team_achievement) + parseFloat(scope.row.self_achievement)}}</el-link>
                                                    </template>
                                                </el-table-column>
                                                <el-table-column
                                                        align="center"
        ...
        App = new Vue({
            ...
            methods:{
                ...
                getAchievementList: function(){
                    ...
                    $.post("<?= url('user.team/getAchievementList') ?>", {page, scene, user_id, month, year, size}, function(res){
