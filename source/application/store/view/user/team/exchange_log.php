                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        ...
                                        <p><?= $item['user']['grade']['name']?></p>
                                    </td>
                                    <td class="am-text-middle">
                                        <p><?= $item['old_invitation']['nickName']?></p>
                                        <p><?= $item['old_invitation']['grade']['name']?></p>
                                    </td>
                                    <td class="am-text-middle">
                                        <p><?= $item['new_invitation']['nickName']?></p>
                                        <p><?= $item['new_invitation']['grade']['name']?></p>
                                    </td>
