                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <?php if (checkPrivilege('finance.dealer.withdraw/export')): ?>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (in_array($item['apply_status'], [10, 20])) : ?>
                                                <?php if (checkPrivilege('finance.dealer.withdraw/submit')): ?>
                                                ...
                                                <?php if ($item['apply_status'] == 20) : ?>
                                                    <?php if (checkPrivilege('finance.dealer.withdraw/money')): ?>
                                                ...
                                                <?php if ($item['apply_status'] == 20 && $item['pay_type']['value'] == 10) : ?>
                                                    <?php if (checkPrivilege('finance.dealer.withdraw/wechat_pay')): ?>
                                                ...
                                                <?php if (checkPrivilege('user.order/index')): ?>
                                                    <a class="tpl-table-black-operation-green" target="_blank" href="<?= url('user.order/index', ['user_id' => $item['user_id']]) ?>">明细
                                                    </a>
                                                <?php endif; ?>
                                            <?php endif; ?>
...
<script id="tpl-dealer-withdraw" type="text/template">
    <div class="am-padding-top-sm">
        <form class="form-dealer-withdraw am-form tpl-form-line-form" method="post"
              action="<?= url('finance.dealer.withdraw/submit') ?>">
...
<script>
    $(function () {
        ...
        $('.j-money').click(function () {
            var id = $(this).data('id');
            var url = "<?= url('finance.dealer.withdraw/money') ?>";
        ...
        $('.j-wechat-pay').click(function () {
            var id = $(this).data('id');
            var url = "<?= url('finance.dealer.withdraw/wechat_pay') ?>";
        ...
        $('.j-export').click(function () {
            ...
            window.location = "<?= url('finance.dealer.withdraw/export') ?>" + '&' + $.urlEncode(data);
        });
