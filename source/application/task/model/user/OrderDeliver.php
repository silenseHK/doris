...
class OrderDeliver extends OrderDeliverModel
{
    ...
    public static function getAutoCancelList(){
        ...
        return $model->field(['deliver_id', 'goods_id', 'user_id', 'goods_num', 'goods_sku_id', 'order_no'])->select();
    }
    ...
    public static function getAutoCompleteList(){
        ...
        return $model->field(['deliver_id', 'goods_id', 'user_id', 'goods_num', 'goods_sku_id', 'freight_money', 'order_no'])->select();
    }
